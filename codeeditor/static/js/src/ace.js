(function() {
    ...
    (function() {
        r.implement(this, i), this.setTokenizer = function(e) {
            ...
            var t = e.range,
                n = t.start.row,
                r = t.end.row - n;
            if (r === 0) this.lines[n] = null;
            else if (e.action == "removeText" || e.action == "removeLines") this.lines.splice(n, r + 1, null), this.states.splice(n, r + 1, null);
            else {
                var i = Array(r + 1);
    ...
    (function() {
        this.comparePoints = i, this.pointIndex = function(e, t, n) {
            ...
            var t = e.data.range;
            if (e.data.action[0] == "i") var n = t.start,
                r = t.end;
            else var r = t.start,
                n = t.end;
            var i = n.row,
    ...
    function u() {
        this.getFoldAt = function(e, t, n) {
            ...
            var t = e.data,
                ...
                r = n.start.row,
                i = n.end.row - r;
            if (i === 0) this.foldWidgets[r] = null;
            else if (t.action == "removeText" || t.action == "removeLines") this.foldWidgets.splice(r, i + 1, null);
            else {
                var s = Array(i + 1);
    ...
    u.prototype = o.prototype,
        function() {
            this.addCommand = function(e) {
                ...
                var r = this.commandKeyBinding,
                    i;
                t ? !r[e] || this.$singleCommand ? r[e] = t : (Array.isArray(r[e]) ? (i = r[e].indexOf(t)) != -1 && r[e].splice(i, 1) : r[e] = [r[e]], n || t.isDefault ? r[e].unshift(t) : r[e].push(t)) : delete r[e]
                ...
                return e.$keyChain && r > 0 && (e.$keyChain = ""), {
                    command: o
                }
            }
        ...
        r.implement(this, d), this.$initOperationListeners = function() {
            ...
            if (this.curOp) {
                ...
                if (t && t.scrollIntoView) {
                    ...
                    t.scrollIntoView == "animate" && this.renderer.animateScrolling(this.curOp.scrollTop)
                }
            ...
            if (!this.inMultiSelectMode || this.inVirtualSelectionMode) this.insert(e);
            else {
                var n = e.split(/\r\n|\r|\n/),
    ...
    (function() {
        i.implement(this, o), this.setSession = function(e) {
            ...
            var t = e.data,
                ...
                i = n.end.row - r;
            if (i !== 0)
                if (t.action == "removeText" || t.action == "removeLines") this.$annotations.splice(r, i + 1, null);
                else {
                    var s = new Array(i + 1);
    ...
    (function() {
        r.implement(this, u), this.EOF_CHAR = "\u00b6", this.EOL_CHAR_LF = "\u00ac", this.EOL_CHAR_CRLF = "\u00a4", this.EOL_CHAR = this.EOL_CHAR_LF, this.TAB_CHAR = "\u2192", this.SPACE_CHAR = "\u00b7", this.$padding = 0, this.$updateEolChar = function() {
            ...
            if (this.displayIndentGuides) {
                ...
                if (this.showInvisibles) {
                    ...
                    var u = s.stringRepeat(this.SPACE_CHAR, this.tabSize),
                        a = this.TAB_CHAR + s.stringRepeat(" ", this.tabSize - 1)
            ...
            for (var a = 0; a < t.length; a++) {
                ...
                if (i + l.length < o) u = this.$renderToken(e, u, f, l), i += l.length;
                else {
    ...
    (function() {
        this.CHANGE_CURSOR = 1, this.CHANGE_MARKER = 2, this.CHANGE_GUTTER = 4, this.CHANGE_SCROLL = 8, this.CHANGE_LINES = 16, this.CHANGE_TEXT = 32, this.CHANGE_SIZE = 64, this.CHANGE_MARKER_BACK = 128, this.CHANGE_MARKER_FRONT = 256, this.CHANGE_FULL = 512, this.CHANGE_H_SCROLL = 1024, r.implement(this, v), this.updateCharacterSize = function() {
            ...
            var e = this.session,
                ...
                o = t.scrollerHeight + this.lineHeight,
                u = this.$getLongestLine(),
                a = !n && (this.$hScrollBarAlwaysVisible || t.scrollerWidth - u - 2 * this.$padding < 0),
                f = this.$horizScroll !== a;
            f && (this.$horizScroll = a, this.scrollBarH.setVisible(a));
            var l = !this.$maxLines && this.$scrollPastEnd ? (t.scrollerHeight - this.lineHeight) * this.$scrollPastEnd : 0;
            i += l, this.session.setScrollTop(Math.max(-this.scrollMargin.top, Math.min(this.scrollTop, i - t.scrollerHeight + this.scrollMargin.bottom))), this.session.setScrollLeft(Math.max(-this.scrollMargin.left, Math.min(this.scrollLeft, u + 2 * this.$padding - t.scrollerWidth + this.scrollMargin.right)));
            var c = !n && (this.$vScrollBarAlwaysVisible || t.scrollerHeight - i + l < 0 || this.scrollTop),
                h = this.$vScroll !== c;
            h && (this.$vScroll = c, this.scrollBarV.setVisible(c));
            var p = Math.ceil(o / this.lineHeight) - 1,
                d = Math.max(0, Math.round((this.scrollTop - s) / this.lineHeight)),
                v = d + p,
                m, g, y = this.lineHeight;
            d = e.screenToDocumentRow(d, 0);
            var b = e.getFoldLine(d);
            b && (d = b.start.row), m = e.documentToScreenRow(d, 0), g = e.getRowLength(d) * y, v = Math.min(e.screenToDocumentRow(v, 0), e.getLength() - 1), o = t.scrollerHeight + e.getRowLength(v) * y + g, s = this.scrollTop - m * y;
            var w = 0;
            this.layerConfig.width != u && (w = this.CHANGE_H_SCROLL);
            if (f || h) w = this.$updateCachedSize(!0, this.gutterWidth, t.width, t.height), this._signal("scrollbarVisibilityChanged"), h && (u = this.$getLongestLine());
    ...
    (function() {
        r.implement(this, s), this.onMessage = function(e) {
            ...
            if (!e) return;
            this.deltaQueue = null, e.length > 20 && e.length > this.$doc.getLength() >> 1 ? this.call("setValue", [this.$doc.getValue()]) : this.emit("change", {
                data: e
            })
    ...
    function o(e) {
        ...
        var l = e.editor,
            ...
            E = w,
            S;
        if (l.$mouseHandler.$enableJumpToDef) u && n || a && n ? S = "add" : n && (S = "block");
        else if (a && !n) {
            S = "add";
            if (!h && o) return
        } else n && (S = "block");
